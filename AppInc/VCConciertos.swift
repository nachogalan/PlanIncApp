...
class VCConciertos: UIViewController, UITableViewDelegate, UITableViewDataSource, DataHolderDelegate {
    ...
    override func viewDidLoad() {
        ...
        DataHolder.sharedInstance.descargarPlanesConciertos(delegate:self)
