...
class VCBares:UIViewController, UITableViewDelegate, UITableViewDataSource, DataHolderDelegate {
    ...
    override func viewDidLoad() {
        ...
        DataHolder.sharedInstance.descargarPlanesBares(delegate:self)
