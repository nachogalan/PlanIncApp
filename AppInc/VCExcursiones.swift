...
class VCExcursiones:UIViewController, UITableViewDelegate, UITableViewDataSource, DataHolderDelegate {
    ...
    override func viewDidLoad() {
        ...
        DataHolder.sharedInstance.descargarPlanesExcursiones(delegate:self)
