...
class VCQuedadas: UIViewController, UITableViewDelegate, UITableViewDataSource, DataHolderDelegate {
    ...
    override func viewDidLoad() {
        ...
        DataHolder.sharedInstance.descargarPlanesQuedadas(delegate:self)
