...
//  AppInc
//
//  Created by IGNACIO GALAN DE PINA on 8/6/18.
//  Copyright © 2018 IGNACIO GALAN DE PINA. All rights reserved.
//

import UIKit

class VCVideojuegos:UIViewController, UITableViewDelegate, UITableViewDataSource, DataHolderDelegate {
    ...
    override func viewDidLoad() {
        ...
        DataHolder.sharedInstance.descargarPlanesVideojuegos(delegate:self)
